...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [onequarter, degree, onehalf, percent, exclamdown, exclam, yen, fraction, dollar, eight, sterling, .notdef, currency, threequarters, Euro, zero]
...
* ℹ **INFO** This font contains the following optional tables [cvt , GPOS, loca, fpgm, GSUB, prep, DSIG, gasp]
