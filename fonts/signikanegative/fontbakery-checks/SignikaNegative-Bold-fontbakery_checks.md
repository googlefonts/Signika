...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [fraction, threequarters, dollar, Euro, degree, exclam, zero, exclamdown, percent, onequarter, sterling, currency, yen, eight, onehalf, .notdef]
...
* ℹ **INFO** This font contains the following optional tables [cvt , loca, GSUB, GPOS, gasp, prep, DSIG, fpgm]
