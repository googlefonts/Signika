...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [degree, eight, yen, dollar, zero, percent, currency, exclam, sterling, exclamdown, .notdef, fraction, onequarter, onehalf, threequarters, Euro]
...
* ℹ **INFO** This font contains the following optional tables [GPOS, DSIG, gasp, loca, fpgm, cvt , GSUB, prep]
