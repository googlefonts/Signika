...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [Euro, .notdef, fraction, currency, degree, sterling]
...
* ℹ **INFO** This font contains the following optional tables [cvt , fpgm, loca, GSUB, gasp, DSIG, prep, GPOS]
