...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [currency, Euro, degree, .notdef, fraction, sterling]
...
* ℹ **INFO** This font contains the following optional tables [GSUB, loca, cvt , fpgm, GPOS, gasp, prep, DSIG]
