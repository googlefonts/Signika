...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [degree, fraction, Euro, .notdef, sterling, currency]
...
* ℹ **INFO** This font contains the following optional tables [GSUB, GPOS, DSIG, fpgm, cvt , gasp, prep, loca]
