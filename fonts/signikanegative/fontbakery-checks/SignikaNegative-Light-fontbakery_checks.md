...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [fraction, sterling, currency, degree, Euro, .notdef]
...
* ℹ **INFO** This font contains the following optional tables [prep, fpgm, loca, DSIG, GSUB, gasp, GPOS, cvt ]
