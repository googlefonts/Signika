...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [onehalf, yen, sterling, degree, fraction, exclamdown, percent, currency, onequarter, exclam, Euro, eight, .notdef, threequarters]
...
* ℹ **INFO** This font contains the following optional tables [GPOS, prep, cvt , GSUB, gasp, loca, fpgm, DSIG]
