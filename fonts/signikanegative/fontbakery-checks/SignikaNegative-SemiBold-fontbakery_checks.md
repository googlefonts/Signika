...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [.notdef, yen, currency, onehalf, onequarter, sterling, eight, exclamdown, degree, exclam, fraction, threequarters, Euro, percent]
...
* ℹ **INFO** This font contains the following optional tables [gasp, fpgm, GPOS, GSUB, DSIG, prep, cvt , loca]
