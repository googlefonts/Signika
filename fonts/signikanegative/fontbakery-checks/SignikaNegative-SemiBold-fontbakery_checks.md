...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [exclam, fraction, threequarters, onehalf, yen, percent, currency, onequarter, Euro, eight, exclamdown, sterling, degree, .notdef]
...
* ℹ **INFO** This font contains the following optional tables [loca, fpgm, GSUB, gasp, cvt , prep, GPOS, DSIG]
