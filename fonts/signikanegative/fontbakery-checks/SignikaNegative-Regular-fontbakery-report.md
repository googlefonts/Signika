...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [greater, zdotaccent, Acircumflex, ae, ograve, H, Otilde, Egrave, ydieresis, Euro, x, Ydieresis, Eacute, Tcaron, zacute, v, B, thorn, Jcircumflex, guillemotleft, OE, four, y, Atilde, Ucircumflex, eacute, Ldot, Sacute, ccaron, threequarters, ampersand, udieresis, C, N, onequarter, racute, odieresis, Lslash, n, ordmasculine, Agrave, copyright, ucircumflex, eogonek, yen, Ccedilla, Ccaron, zero, backslash, z, paragraph, c, yacute, lslash, Uacute, Icircumflex, K, Ograve, Oslash, Edieresis, I, uring, Aogonek, egrave, O, six, bar, agrave, numbersign, uacute, Dcaron, t, oe, one, k, A, adieresis, atilde, ldot, germandbls, guillemotright, rcaron, ccedilla, questiondown, w, at, Uring, V, J, exclamdown, s, section, U, Z, g, D, iacute, two, dotlessi, M, Itilde, sterling, X, IJ, oacute, Rcaron, ocircumflex, exclam, ntilde, five, Ntilde, .notdef, Q, percent, bracketleft, Ecaron, cent, E, o, less, ugrave, aogonek, Ocircumflex, Idieresis, three, R, u, Zcaron, Udieresis, Hbar, ncaron, G, Zacute, h, Iacute, Eogonek, tcaron, hbar, l, d, Ncaron, P, jcircumflex, Racute, nacute, Eth, eight, ecircumflex, parenleft, braceleft, aacute, j, registered, L, m, F, otilde, f, sacute, edieresis, S, bracketright, igrave, Aacute, W, question, T, dollar, Ugrave, Thorn, aring, Oacute, nine, parenright, Igrave, Scaron, zcaron, itilde, ij, i, Yacute, q, Odieresis, ecaron, Nacute, Aring, b, dcaron, p, asciicircum, slash, icircumflex, Zdotaccent, cacute, eth, AE, kgreenlandic, Ecircumflex, multiply, brokenbar, e, Cacute, idieresis, Y, acircumflex, a, scaron, braceright, Adieresis, oslash, plusminus, currency, onehalf, fraction, seven]
...
* :information_source: **INFO** This font contains the following optional tables [gasp, cvt , GPOS, loca, fpgm, prep, DSIG, GSUB]
