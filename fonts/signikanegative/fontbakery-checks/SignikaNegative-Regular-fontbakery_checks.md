...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [percent, degree, Euro, .notdef, fraction, currency, sterling]
...
* ℹ **INFO** This font contains the following optional tables [prep, fpgm, loca, gasp, cvt , DSIG, GPOS, GSUB]
...
* 🍞 **PASS** fonts/signikanegative/SignikaNegative-Regular.ttf is named canonically.
