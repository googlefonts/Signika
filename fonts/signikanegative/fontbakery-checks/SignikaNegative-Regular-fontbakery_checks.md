...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [Euro, sterling, degree, currency, percent, .notdef, fraction]
...
* ℹ **INFO** This font contains the following optional tables [fpgm, DSIG, gasp, loca, GSUB, prep, GPOS, cvt ]
