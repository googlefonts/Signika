...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [sterling, degree, fraction, currency, Euro, .notdef, percent]
...
* ℹ **INFO** This font contains the following optional tables [GSUB, cvt , prep, fpgm, DSIG, loca, GPOS, gasp]
