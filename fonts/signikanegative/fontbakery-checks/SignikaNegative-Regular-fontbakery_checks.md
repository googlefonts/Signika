...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [sterling, Euro, percent, degree, .notdef, currency, fraction]
...
* ℹ **INFO** This font contains the following optional tables [DSIG, fpgm, gasp, prep, GPOS, GSUB, cvt , loca]
