...
* :fire: **FAIL** Unmatched family name in font: TTF has "Signika Negative SemiBold" while METADATA.pb has "Signika Negative" [code: mismatch]
...
* :fire: **FAIL** METADATA.pb Family name "Signika Negative") does not match name table entry "Signika Negative SemiBold" ! [code: familyname-mismatch]
...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [Ecaron, Ecircumflex, .notdef, at]
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, loca, prep, fpgm, GSUB, DSIG, cvt , gasp]
...
* :bread: **PASS** fonts/signikanegative/SignikaNegative-SemiBold.ttf is named canonically.
...
* :bread: **PASS** Postscript name "SignikaNegative-SemiBold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Font fullname "Signika Negative SemiBold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Signika Negative' in 'Signika Negative SemiBold')
