...
* :information_source: **INFO** This font contains the following optional tables [loca, fpgm, DSIG, prep, gasp, GSUB, cvt , GPOS]
...
* :information_source: **INFO** OS/2 xAvgCharWidth is 1021 but should be 1019 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font. These are similar values, which may be a symptom of the slightly different calculation of the xAvgCharWidth value in font editors. There's further discussion on this at https://github.com/googlefonts/fontbakery/issues/1622
...
* :bread: **PASS** fonts/signikanegative/SignikaNegative-Light.ttf is named canonically.
...
* :bread: **PASS** Postscript name "SignikaNegative-Light" is identical in METADATA.pb and on the TTF file.
