...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [ocircumflex, Uring, currency, bracketleft, sterling, G, IJ, Icircumflex, AE, scaron, f, F, parenright, Uacute, nine, Rcaron, Idieresis, x, lslash, Oacute, udieresis, V, onequarter, Aogonek, ydieresis, ccedilla, otilde, Igrave, zero, h, guillemotleft, eight, Thorn, exclamdown, dotlessi, uring, ecaron, rcaron, R, three, eogonek, braceright, a, egrave, L, u, hbar, ldot, atilde, edieresis, exclam, Racute, brokenbar, plusminus, Egrave, Euro, m, g, w, ucircumflex, C, Eth, dollar, one, two, l, ntilde, b, aogonek, ij, Otilde, tcaron, questiondown, yacute, percent, section, parenleft, Edieresis, jcircumflex, v, ccaron, adieresis, icircumflex, dcaron, Ccedilla, odieresis, five, germandbls, H, J, Ydieresis, OE, asciicircum, Zdotaccent, Ccaron, Aring, threequarters, z, idieresis, i, eth, sacute, aacute, ecircumflex, Odieresis, oe, Ldot, Yacute, Nacute, c, Eacute, Lslash, Zcaron, eacute, q, Aacute, aring, Sacute, registered, k, O, six, Agrave, fraction, t, seven, copyright, W, onehalf, iacute, Hbar, Scaron, Zacute, N, Z, Ocircumflex, nacute, Ugrave, oacute, Eogonek, ampersand, Udieresis, e, ncaron, zdotaccent, cent, Oslash, I, ugrave, Ucircumflex, acircumflex, Ograve, at, bar, Y, Cacute, P, Q, Ncaron, igrave, E, question, ograve, Ecaron, S, kgreenlandic, p, Ecircumflex, o, X, bracketright, numbersign, Itilde, y, .notdef, slash, Jcircumflex, oslash, racute, backslash, greater, multiply, Iacute, guillemotright, four, uacute, zacute, braceleft, Acircumflex, Dcaron, D, Tcaron, agrave, d, M, A, zcaron, U, T, K, s, Ntilde, thorn, ordmasculine, paragraph, cacute, Atilde, j, B, ae, yen, itilde, Adieresis, less, n]
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, GSUB, GPOS, prep, loca, cvt , DSIG, gasp]
