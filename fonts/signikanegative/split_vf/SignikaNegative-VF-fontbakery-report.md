...
<details>
<summary><b>[118] SignikaNegative-VF.ttf</b></summary>
<details>
...
* :fire: **FAIL** Unmatched postscript name in font: TTF has "SignikaNegative" while METADATA.pb has "Signika-Light". [code: mismatch]
...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Signika Negative" while METADATA.pb has "Signika Negative Light". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font filename="SignikaNegative-VF.ttf" does not match post_script_name="Signika-Light".
...
* :fire: **FAIL** METADATA.pb: filename field ("SignikaNegative-VF.ttf") does not match canonical name "SignikaNegative-Light.ttf".
...
* :fire: **FAIL** METADATA.pb: Fullname ("Signika Negative Light") does not match name table entry "Signika Negative" ! [code: fullname-mismatch]
...
* :information_source: **INFO** This font contains the following optional tables [prep, loca, cvt , GPOS, GSUB, fpgm, DSIG, gasp]
...
* :bread: **PASS** fonts/signikanegative/split_vf/SignikaNegative-VF.ttf is named canonically.
