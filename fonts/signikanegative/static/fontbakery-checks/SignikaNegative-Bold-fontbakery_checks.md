...
|  | instance_ttf/SignikaNegative-Bold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [loca, gasp, GSUB, fpgm, prep, DSIG, GPOS, cvt ]
...
* :information_source: **INFO** OS/2 xAvgCharWidth is 1085 but should be 1083 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font. These are similar values, which may be a symptom of the slightly different calculation of the xAvgCharWidth value in font editors. There's further discussion on this at https://github.com/googlefonts/fontbakery/issues/1622
...
* :bread: **PASS** instance_ttf/SignikaNegative-Bold.ttf is named canonically.
