...
* :fire: **FAIL** OS/2.usWinAscent value should be equal or greater than 1916, but got 1700 instead [code: ascent]
...
|  | fonts/signikanegative/static/SignikaNegative-Light.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [cvt , GPOS, prep, DSIG, GSUB, fpgm, gasp, loca]
...
* :bread: **PASS** fonts/signikanegative/static/SignikaNegative-Light.ttf is named canonically.
