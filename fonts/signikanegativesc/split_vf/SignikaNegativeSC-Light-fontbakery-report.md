...
* :fire: **FAIL** None of the METADATA.pb filename fields match correct font name format ("SignikaNegativeSC-Light.ttf").
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, GSUB, fpgm, gasp, cvt , prep, DSIG, loca]
