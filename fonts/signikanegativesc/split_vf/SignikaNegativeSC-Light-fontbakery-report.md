...
* :bread: **PASS** fonts/signikanegativesc/split_vf/DESCRIPTION.en_us.html is a propper HTML file.
...
<details>
<summary><b>[117] SignikaNegativeSC-Light.ttf</b></summary>
<details>
...
* :fire: **FAIL** Style name used in "fonts/signikanegativesc/split_vf/SignikaNegativeSC-Light.ttf" is not canonical. You should rebuild the font using any of the following style names: "Thin", "ExtraLight", "Light", "Regular", "Medium", "SemiBold", "Bold", "ExtraBold", "Black", "Thin Italic", "ExtraLight Italic", "Light Italic", "Italic", "Medium Italic", "SemiBold Italic", "Bold Italic", "ExtraBold Italic", "Black Italic".
...
* :fire: **FAIL** METADATA.pb font full_name="Signika Negative SC Light" does not match post_script_name = "Signika-Light"
...
* :fire: **FAIL** METADATA.pb font filename="SignikaNegativeSC-Light.ttf" does not match post_script_name="Signika-Light".
...
* :fire: **FAIL** METADATA.pb postScriptName ("Signika-Light") does not match correct font name format ("Signika Negative SC Light").
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Signika Negative SC Light' / SUBFAMILY_NAME = 'Regular'
...
* :information_source: **INFO** This font contains the following optional tables [fpgm, GSUB, DSIG, loca, GPOS, cvt , prep, gasp]
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Signika Negative SC' in 'Signika Negative SC Light')
