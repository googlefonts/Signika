...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Signika Negative SC Regular" while METADATA.pb has "Signika Negative SC Light". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb font filename="SignikaNegativeSC-VF.ttf" does not match post_script_name="Signika-Light".
...
* :fire: **FAIL** METADATA.pb: filename field ("SignikaNegativeSC-VF.ttf") does not match canonical name "SignikaNegativeSC-Light.ttf".
...
* :fire: **FAIL** METADATA.pb: Fullname ("Signika Negative SC Light") does not match name table entry "Signika Negative SC Regular" ! [code: fullname-mismatch]
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1027 but it should be 1050 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Signika Negative SC' / SUBFAMILY_NAME = 'Regular'
...
* :information_source: **INFO** This font contains the following optional tables [gasp, prep, cvt , GPOS, GSUB, DSIG, fpgm, loca]
...
* :bread: **PASS** fonts/signikanegativesc/split_vf/SignikaNegativeSC-VF.ttf is named canonically.
