...
* :warning: **WARN** OS/2 xAvgCharWidth is 1075 but it should be 1100 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, DSIG, loca, prep, fpgm, GPOS, cvt , gasp]
