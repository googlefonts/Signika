...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Signika Negative SC SemiBold' but got 'Signika Negative SC SemiBold SC'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Signika Negative SC SemiBold' but got 'Signika Negative SC SemiBold SC Regular'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'SignikaNegativeSC-SemiBold' but got 'SignikaNegativeSCSC-SemiBold'.
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Signika Negative SC SemiBold SC' / SUBFAMILY_NAME = 'Regular'
...
|  | instance_ttf/SignikaNegativeSC-SemiBold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [gasp, prep, cvt , fpgm, loca, GPOS, GSUB]
...
* :bread: **PASS** instance_ttf/SignikaNegativeSC-SemiBold.ttf is named canonically.
