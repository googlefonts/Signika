...
* :warning: **WARN** OS/2 xAvgCharWidth is 1084 but it should be 1112 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [DSIG, GPOS, GSUB, cvt , loca, prep, fpgm, gasp]
