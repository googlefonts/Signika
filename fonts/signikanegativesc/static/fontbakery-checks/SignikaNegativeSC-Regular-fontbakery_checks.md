...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Signika Negative SC Regular' but got 'Signika Negative SC SC Regular'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'SignikaNegativeSC-Regular' but got 'SignikaNegativeSCSC-Regular'.
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, cvt , fpgm, GPOS, prep, loca, gasp]
...
* :bread: **PASS** instance_ttf/SignikaNegativeSC-Regular.ttf is named canonically.
