...
<details>
<summary><b>[117] SignikaNegativeSC-SemiBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** OS/2.usWinAscent value should be equal or greater than 1968, but got 1700 instead [code: ascent]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Signika Negative SC SemiBold' / SUBFAMILY_NAME = 'Regular'
...
|  | fonts/signikanegativesc/static/SignikaNegativeSC-SemiBold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [cvt , DSIG, GPOS, loca, prep, GSUB, fpgm, gasp]
...
* :bread: **PASS** fonts/signikanegativesc/static/SignikaNegativeSC-SemiBold.ttf is named canonically.
