...
* :warning: **WARN** OS/2 xAvgCharWidth is 1043 but it should be 1065 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [cvt , GPOS, prep, gasp, fpgm, loca, DSIG, GSUB]
