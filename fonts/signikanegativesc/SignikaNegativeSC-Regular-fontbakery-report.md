...
<details>
<summary><b>[118] SignikaNegativeSC-Regular.ttf</b></summary>
<details>
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1045 but it should be 1067 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
|  | fonts/signikanegativesc/SignikaNegativeSC-Regular.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [gasp, DSIG, fpgm, loca, GSUB, GPOS, prep, cvt ]
...
* :bread: **PASS** fonts/signikanegativesc/SignikaNegativeSC-Regular.ttf is named canonically.
...
* :bread: **PASS** Postscript name "SignikaNegativeSC-Regular" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Font fullname "Signika Negative SC Regular" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Signika Negative SC' in 'Signika Negative SC Regular')
