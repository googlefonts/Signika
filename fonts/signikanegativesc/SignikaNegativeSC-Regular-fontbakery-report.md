...
* :warning: **WARN** OS/2 xAvgCharWidth is 1050 but it should be 1075 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, DSIG, cvt , prep, fpgm, gasp, loca, GSUB]
