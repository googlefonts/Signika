...
* :fire: **FAIL** METADATA.pb postScriptName ("SignikaNegativeSC-Light") does not match correct font name format ("Signika Negative Light SC").
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1021 but it should be 1041 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [cvt , DSIG, prep, gasp, loca, fpgm, GPOS, GSUB]
...
* :bread: **PASS** fonts/signikanegativesc/SignikaNegativeSC-Light.ttf is named canonically.
...
* :bread: **PASS** Postscript name "SignikaNegativeSC-Light" is identical in METADATA.pb and on the TTF file.
