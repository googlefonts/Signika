...
<details>
<summary><b>[118] SignikaSCSC-Bold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Signika S C SC' but got 'Signika SC SC'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Signika S C SC Bold' but got 'Signika SC SC Bold'.
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1090 but it should be 1119 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
|  | instance_ttf/SignikaSCSC-Bold.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, prep, cvt , fpgm, gasp, DSIG, GSUB, loca]
...
* :bread: **PASS** instance_ttf/SignikaSCSC-Bold.ttf is named canonically.
