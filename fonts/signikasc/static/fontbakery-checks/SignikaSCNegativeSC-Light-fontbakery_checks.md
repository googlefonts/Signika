...
<details>
<summary><b>[118] SignikaSCNegativeSC-Light.ttf</b></summary>
<details>
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Signika S C Negative SC Light' but got 'Signika Negative Light SC SC'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Signika S C Negative SC Light' but got 'Signika Negative Light SC SC Regular'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'SignikaSCNegativeSC-Light' but got 'SignikaNegativeSCSC-Light'.
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Signika Negative Light SC SC' / SUBFAMILY_NAME = 'Regular'
...
|  | instance_ttf/SignikaSCNegativeSC-Light.ttf |
|:--- | ---:|
| Dehinted Size | 60.8kb |
| Hinted Size | 78.3kb |
| Increase | 17.5kb |
| Change   | 28.8 % |
...
* :information_source: **INFO** This font contains the following optional tables [prep, loca, GSUB, GPOS, fpgm, cvt , DSIG, gasp]
...
* :bread: **PASS** instance_ttf/SignikaSCNegativeSC-Light.ttf is named canonically.
