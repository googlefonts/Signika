...
<details>
<summary><b>[118] SignikaSCNegativeSC-Bold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Signika S C Negative SC Bold' but got 'Signika Negative SC SC Bold'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'SignikaSCNegativeSC-Bold' but got 'SignikaNegativeSCSC-Bold'.
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1085 but it should be 1075 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Signika Negative SC SC' / SUBFAMILY_NAME = 'Bold'
...
|  | instance_ttf/SignikaSCNegativeSC-Bold.ttf |
|:--- | ---:|
| Dehinted Size | 62.8kb |
| Hinted Size | 82.6kb |
| Increase | 19.7kb |
| Change   | 31.4 % |
...
* :information_source: **INFO** This font contains the following optional tables [cvt , fpgm, GPOS, gasp, loca, GSUB, DSIG, prep]
...
* :bread: **PASS** instance_ttf/SignikaSCNegativeSC-Bold.ttf is named canonically.
