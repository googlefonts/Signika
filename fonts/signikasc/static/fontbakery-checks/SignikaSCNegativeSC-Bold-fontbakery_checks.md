...
* :warning: **WARN** OS/2 xAvgCharWidth is 1085 but it should be 1113 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [gasp, GSUB, fpgm, cvt , loca, GPOS, prep, DSIG]
