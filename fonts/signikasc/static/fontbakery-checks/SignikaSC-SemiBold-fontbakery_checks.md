...
* :warning: **WARN** OS/2 xAvgCharWidth is 1070 but it should be 1097 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [prep, fpgm, GSUB, gasp, GPOS, DSIG, loca, cvt ]
