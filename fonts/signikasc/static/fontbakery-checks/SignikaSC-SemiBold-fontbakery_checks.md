...
* :warning: **WARN** OS/2 xAvgCharWidth is 1071 but it should be 1098 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, GPOS, DSIG, loca, prep, gasp, fpgm, cvt ]
...
* :bread: **PASS** instance_ttf/SignikaSC-SemiBold.ttf is named canonically.
