...
<details>
<summary><b>[118] SignikaSCSC-Light.ttf</b></summary>
<details>
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Signika S C SC Light' but got 'Signika Light SC SC'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Signika S C SC Light' but got 'Signika Light SC SC Regular'.
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Signika Light SC SC' / SUBFAMILY_NAME = 'Regular'
...
|  | instance_ttf/SignikaSCSC-Light.ttf |
|:--- | ---:|
...
* :information_source: **INFO** This font contains the following optional tables [prep, GSUB, fpgm, GPOS, loca, gasp, cvt , DSIG]
...
* :bread: **PASS** instance_ttf/SignikaSCSC-Light.ttf is named canonically.
