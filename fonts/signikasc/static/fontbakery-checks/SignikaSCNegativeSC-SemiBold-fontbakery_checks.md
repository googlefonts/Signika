...
<details>
<summary><b>[118] SignikaSCNegativeSC-SemiBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Signika S C Negative SC SemiBold' but got 'Signika Negative SemiBold SC SC'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Signika S C Negative SC SemiBold' but got 'Signika Negative SemiBold SC SC Regular'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'SignikaSCNegativeSC-SemiBold' but got 'SignikaNegativeSCSC-SemiBold'.
...
* :warning: **WARN** OS/2 xAvgCharWidth is 1066 but it should be 1093 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Signika Negative SemiBold SC SC' / SUBFAMILY_NAME = 'Regular'
...
|  | instance_ttf/SignikaSCNegativeSC-SemiBold.ttf |
|:--- | ---:|
| Dehinted Size | 62.1kb |
| Hinted Size | 83.1kb |
| Increase | 21.0kb |
| Change   | 33.9 % |
...
* :information_source: **INFO** This font contains the following optional tables [prep, cvt , GSUB, DSIG, GPOS, loca, fpgm, gasp]
...
* :bread: **PASS** instance_ttf/SignikaSCNegativeSC-SemiBold.ttf is named canonically.
