...
* :warning: **WARN** OS/2 xAvgCharWidth is 1055 but it should be 1080 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [GSUB, gasp, GPOS, fpgm, cvt , loca, prep, DSIG]
