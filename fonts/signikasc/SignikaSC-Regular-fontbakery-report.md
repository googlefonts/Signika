...
* :warning: **WARN** OS/2 xAvgCharWidth is 1050 but it should be 1072 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [gasp, DSIG, fpgm, GSUB, loca, cvt , prep, GPOS]
...
* :bread: **PASS** fonts/signikasc/SignikaSC-Regular.ttf is named canonically.
...
* :bread: **PASS** Postscript name "SignikaSC-Regular" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Font fullname "Signika SC Regular" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Signika SC' in 'Signika SC Regular')
