...
* :warning: **WARN** OS/2 xAvgCharWidth is 1082 but it should be 1108 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, gasp, prep, loca, DSIG, GSUB, cvt , fpgm]
...
* :bread: **PASS** fonts/signikasc/SignikaSC-Bold.ttf is named canonically.
...
* :bread: **PASS** Postscript name "SignikaSC-Bold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Font fullname "Signika SC Bold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Signika SC' in 'Signika SC Bold')
