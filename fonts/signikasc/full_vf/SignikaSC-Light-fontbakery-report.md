...
* :fire: **FAIL** Unmatched fullname in font: TTF has "Signika SC" while METADATA.pb has "Signika SC Light". [code: mismatch]
...
* :fire: **FAIL** METADATA.pb: Fullname ("Signika SC Light") does not match name table entry "Signika SC" ! [code: fullname-mismatch]
...
* :fire: **FAIL** Copyright field for this font on METADATA.pb ('Copyright 2018 The Signika Project Authors (https://github.com/thundernixon/Signika), with Reserved Font Names 'Signika'.') differs from a copyright notice entry on the name table: 'Copyright 2018 by Anna Giedrys. All rights reserved. Reserved Font Name: Signika.'
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Signika SC Light' but got 'Signika SC'.
...
|  | fonts/signikasc/full_vf/SignikaSC-Light.ttf |
|:--- | ---:|
| Dehinted Size | 202.2kb |
| Hinted Size | 225.2kb |
| Increase | 23.0kb |
| Change   | 11.4 % |
