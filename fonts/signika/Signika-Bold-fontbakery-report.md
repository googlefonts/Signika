...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [exclamdown, germandbls.smcp, .notdef, exclam]
...
* :information_source: **INFO** This font contains the following optional tables [gasp, DSIG, cvt , prep, GPOS, fpgm, loca, GSUB]
...
* :information_source: **INFO** OS/2 xAvgCharWidth is 1081 but should be 1079 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font. These are similar values, which may be a symptom of the slightly different calculation of the xAvgCharWidth value in font editors. There's further discussion on this at https://github.com/googlefonts/fontbakery/issues/1622
...
* :bread: **PASS** fonts/signika/Signika-Bold.ttf is named canonically.
...
* :bread: **PASS** Postscript name "Signika-Bold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Font fullname "Signika Bold" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Signika' in 'Signika Bold')
