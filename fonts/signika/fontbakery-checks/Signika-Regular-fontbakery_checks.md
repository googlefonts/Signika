...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [currency, Euro, sterling, .notdef, fraction, percent, degree]
...
* ℹ **INFO** This font contains the following optional tables [DSIG, GPOS, prep, cvt , GSUB, loca, gasp, fpgm]
