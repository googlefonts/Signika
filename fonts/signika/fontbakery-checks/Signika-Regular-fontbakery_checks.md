...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [sterling, degree, onehalf, Euro, currency, fraction, percent, .notdef]
...
* ℹ **INFO** This font contains the following optional tables [fpgm, loca, DSIG, gasp, GPOS, GSUB, prep, cvt ]
