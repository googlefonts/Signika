...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [T, t, D, IJ, Iacute, egrave, J, w, g, Idieresis, Eth, e.smcp, B, fraction, t.smcp, currency, ntilde, Ugrave, F, Ecaron, a.smcp, f.smcp, braceleft, j, agrave, ograve, ij.smcp, copyright, a, Aacute, ucircumflex.smcp, two, Euro, x, cent, R, L, adieresis.smcp, Uring, question, Itilde, nacute.smcp, dcaron.smcp, eth, itilde, ecircumflex.smcp, paragraph, Q, zero, A, b, eacute, aacute.smcp, x.smcp, Edieresis, c, guillemotleft, Ccedilla, X, lslash.smcp, hbar.smcp, idieresis, adieresis, germandbls, lslash, i, Agrave, ccaron, S, K, uring, ampersand, equal, o, questiondown, otilde.smcp, Oslash, registered, plusminus, ij, idieresis.smcp, onehalf, Rcaron, Icircumflex, Tcaron, zacute, ncaron, icircumflex.smcp, d.smcp, .notdef, parenleft, Odieresis, germandbls.smcp, jcircumflex, AE, n.smcp, eogonek.smcp, oslash.smcp, uring.smcp, bar, G, at, Dcaron, thorn.smcp, zcaron.smcp, braceright, e, eacute.smcp, y, slash, acircumflex, Aring, k, Adieresis, zcaron, Uacute, oslash, zdotaccent, h.smcp, Igrave, Nacute, kgreenlandic, onequarter, zdotaccent.smcp, aogonek.smcp, ugrave, oacute.smcp, sterling, aacute, guillemotright, q, u.smcp, brokenbar, Ntilde, six, igrave.smcp, ccedilla.smcp, ldot, q.smcp, Ccaron, Ecircumflex, atilde, n, u, Zdotaccent, l.smcp, seven, four, s.smcp, Yacute, cacute.smcp, m, f, ccaron.smcp, uacute.smcp, Lslash, Eacute, uacute, d, tcaron, ordfeminine, j.smcp, oe, sacute, aring.smcp, Ograve, ydieresis.smcp, l, aogonek, five, ecaron, hbar, ecircumflex, ccedilla, percent, ydieresis, section, ae, Egrave, racute.smcp, iacute.smcp, ograve.smcp, Jcircumflex, OE, udieresis, Ucircumflex, yen, yacute, ntilde.smcp, rcaron, Scaron, sacute.smcp, Ncaron, ncaron.smcp, Aogonek, g.smcp, eogonek, one, exclamdown, acircumflex.smcp, otilde, dollar, ugrave.smcp, backslash, jcircumflex.smcp, M, Acircumflex, three, thorn, odieresis.smcp, uni0237, scaron, Racute, Zcaron, Zacute, iacute, itilde.smcp, z.smcp, Z, threequarters, parenright, ae.smcp, scaron.smcp, ldot.smcp, r.smcp, v.smcp, bracketleft, agrave.smcp, v, racute, h, numbersign, k.smcp, Ocircumflex, cacute, P, odieresis, ocircumflex.smcp, Y, Hbar, nine, Ydieresis, Sacute, z, nacute, Eogonek, H, W, I, igrave, U, r, C, p, dcaron, tcaron.smcp, E, o.smcp, atilde.smcp, V, O, Cacute, Atilde, b.smcp, zacute.smcp, p.smcp, ecaron.smcp, c.smcp, w.smcp, kgreenlandic.smcp, egrave.smcp, Thorn, eth.smcp, rcaron.smcp, ucircumflex, ocircumflex, aring, yacute.smcp, y.smcp, eight, ordmasculine, oe.smcp, bracketright, m.smcp, exclam, s, Udieresis, udieresis.smcp, Oacute, oacute, edieresis.smcp, N, Ldot, icircumflex, Otilde, edieresis]
...
* :information_source: **INFO** This font contains the following optional tables [gasp, cvt , GSUB, fpgm, GPOS, loca, DSIG, prep]
