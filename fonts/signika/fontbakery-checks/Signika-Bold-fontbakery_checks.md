...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [dollar, yen, exclamdown, fraction, sterling, threequarters, percent, currency, degree, onequarter, onehalf, exclam, uni2074, .notdef, Euro]
...
* ℹ **INFO** This font contains the following optional tables [prep, cvt , fpgm, DSIG, GSUB, loca, GPOS, gasp]
