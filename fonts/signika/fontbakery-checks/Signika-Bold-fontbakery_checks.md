...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [onehalf, exclamdown, Euro, uni2074, degree, exclam, percent, fraction, yen, currency, dollar, sterling, threequarters, onequarter]
...
* ℹ **INFO** This font contains the following optional tables [gasp, GPOS, DSIG, fpgm, cvt , loca, GSUB, prep]
