...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [degree, Euro, .notdef, currency, fraction, sterling]
...
* ℹ **INFO** This font contains the following optional tables [loca, gasp, fpgm, cvt , GSUB, prep, GPOS, DSIG]
