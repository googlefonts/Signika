...
* ⚠ **WARN** Following glyphs differ greatly from Google Fonts version: [degree, .notdef, currency, fraction, sterling, Euro]
...
* ℹ **INFO** This font contains the following optional tables [gasp, fpgm, GPOS, GSUB, cvt , DSIG, loca, prep]
