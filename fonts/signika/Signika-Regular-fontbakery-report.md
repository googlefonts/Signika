...
* :bread: **PASS** fonts/signika/DESCRIPTION.en_us.html is a propper HTML file.
...
* :warning: **WARN** Following glyphs differ greatly from Google Fonts version: [Q, oacute, Zcaron, b.smcp, lslash.smcp, ugrave.smcp, zacute.smcp, ae, Lslash, parenright, OE, m.smcp, cacute.smcp, Eth, ograve.smcp, r, u, k.smcp, l, yacute.smcp, T, racute, Idieresis, hbar.smcp, Egrave, seven, udieresis.smcp, ncaron.smcp, S, eogonek.smcp, Aring, AE, Edieresis, tcaron.smcp, aacute, registered, percent, icircumflex, s, igrave.smcp, edieresis, Iacute, j, ntilde, d.smcp, lslash, y.smcp, aogonek.smcp, O, v, oslash, zero, Cacute, dcaron.smcp, Tcaron, egrave.smcp, ydieresis.smcp, Udieresis, Ugrave, atilde, braceleft, Ldot, zcaron.smcp, Uacute, plusminus, t.smcp, ordfeminine, ccaron.smcp, exclamdown, ncaron, uacute.smcp, acircumflex.smcp, agrave, eacute, thorn, Racute, zcaron, p.smcp, b, ecircumflex, germandbls, w, currency, Dcaron, yen, sacute, eight, bracketleft, ldot.smcp, two, P, f.smcp, l.smcp, Oslash, threequarters, ydieresis, ocircumflex.smcp, adieresis.smcp, Ncaron, x.smcp, idieresis.smcp, ecaron.smcp, Eogonek, onehalf, kgreenlandic, ordmasculine, ecaron, k, ograve, aring.smcp, Y, idieresis, oacute.smcp, bar, Ccaron, six, agrave.smcp, c, r.smcp, Jcircumflex, germandbls.smcp, edieresis.smcp, odieresis.smcp, g.smcp, Icircumflex, Nacute, section, uring.smcp, otilde, Rcaron, question, oe.smcp, yacute, c.smcp, ucircumflex.smcp, dcaron, a.smcp, copyright, Otilde, cacute, Igrave, D, q, racute.smcp, Ydieresis, u.smcp, nacute.smcp, zdotaccent, d, eth.smcp, fraction, Zdotaccent, Ucircumflex, Itilde, ugrave, scaron.smcp, IJ, ae.smcp, scaron, parenleft, I, icircumflex.smcp, z.smcp, Oacute, igrave, braceright, onequarter, paragraph, o.smcp, y, nacute, eacute.smcp, Thorn, zacute, Yacute, five, N, t, g, L, three, Acircumflex, backslash, ntilde.smcp, ij, zdotaccent.smcp, four, cent, F, .notdef, acircumflex, at, A, rcaron.smcp, Odieresis, atilde.smcp, questiondown, z, ccedilla.smcp, jcircumflex, x, o, bracketright, Agrave, kgreenlandic.smcp, j.smcp, Eacute, ampersand, oslash.smcp, h.smcp, odieresis, ccaron, iacute, nine, Atilde, guillemotleft, tcaron, Z, brokenbar, sterling, thorn.smcp, H, E, K, n, e, Ograve, guillemotright, U, ucircumflex, G, ccedilla, f, w.smcp, itilde.smcp, otilde.smcp, e.smcp, hbar, dollar, Ecaron, B, uring, Ecircumflex, adieresis, Zacute, ocircumflex, aacute.smcp, m, aring, v.smcp, Euro, equal, i, itilde, q.smcp, Adieresis, eth, ecircumflex.smcp, Hbar, W, p, eogonek, ldot, oe, n.smcp, uni0237, R, Sacute, J, Ocircumflex, a, uacute, egrave, Uring, V, C, rcaron, Aogonek, s.smcp, Scaron, Ntilde, X, slash, ij.smcp, exclam, h, Aacute, Ccedilla, aogonek, M, jcircumflex.smcp, numbersign, iacute.smcp, one, sacute.smcp, udieresis]
...
* :information_source: **INFO** This font contains the following optional tables [gasp, cvt , GPOS, GSUB, prep, DSIG, fpgm, loca]
...
* :information_source: **INFO** OS/2 xAvgCharWidth is 1048 but should be 1046 which corresponds to the weighted average of the widths of the latin lowercase glyphs in the font. These are similar values, which may be a symptom of the slightly different calculation of the xAvgCharWidth value in font editors. There's further discussion on this at https://github.com/googlefonts/fontbakery/issues/1622
...
* :bread: **PASS** fonts/signika/Signika-Regular.ttf is named canonically.
...
* :bread: **PASS** Family name "Signika" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Postscript name "Signika-Regular" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Font fullname "Signika Regular" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Signika' in 'Signika Regular')
